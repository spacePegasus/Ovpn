...
#Основано на https://github.com/Nyr/openvpn-install и 
...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	clear
	echo 'Начинаем установку OpenVPN'
	echo ""
	...
	read -p "Город: " -e -i Saint_Petersburg EASYRSA_REQ_CITY
	read -p "Название организации: " -e -i IFMO EASYRSA_REQ_ORG
	read -p "E-mail: " -e -i admin@ifmo.ru EASYRSA_REQ_EMAIL
	...
	echo 'set_var EASYRSA_DIGEST "sha128"' >> /etc/openvpn/keys/easy-rsa-master/easyrsa3/vars
